const lang_de = {
    ...
    se_meter_hw_settings : "Zähler-Einstellungen",
    ...
    se_evse_use_divNumPhases : "Phasenumschaltung aktivieren",
    se_evse_use_divNumPhases_tt : "Verwende den NumPhases Pin (GPIO32), um zwischen Einphasen- und Dreiphasenbetrieb umzuschalten.",
...
const lang_en = {
    ...
    se_meter_hw_settings : "Meter Hardware Settings",
    ...
    se_evse_use_divNumPhases : "Three phase operation",
    se_evse_use_divNumPhases_tt : "Use the NumPhases Pin (GPIO32) to switch between one phase and three phase operation",
